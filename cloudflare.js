...
async function captchaSolver(page, context, response) {
    log(`(${'@WilerHttpCC'.green}) Detected protection -> ` + `CloudFlare (JS)`.green);
    ...
    if (await page.title() === "Just a moment...") {
        ...
        if (hcaptcha_box) {
            ...
            try {
                ...
                log(`(${'@WilerHttpCC'.green}) Managed challenge -> ` + `Detected captcha`.green);
                log(`(${'@WilerHttpCC'.green}) Detected element -> ` + `[ captcha box ]`.green);

                captchaDetect = true;
            } catch (e) {
                log(`(${'@WilerHttpCC'.green}) Managed challenge -> ` + `UAM`.green);
            ...
            if (captchaDetect) {
                ...
                log(`(${'@WilerHttpCC'.green}) Element clicked -> ` + `[ captcha box ]`.green);
